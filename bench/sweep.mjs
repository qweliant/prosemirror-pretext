...
console.log(`\nread-after-write p50 (ms/keystroke), ${process.env.THROTTLE ?? 4}x throttle, typing mid-doc:\n`)
console.log('blocks'.padStart(7) + 'DOM'.padStart(9) + 'canvas'.padStart(9) + '   DOM grows?')
for (const r of rows) console.log(String(r.size).padStart(7) + r.dom.toFixed(3).padStart(9) + r.canvas.toFixed(3).padStart(9))
